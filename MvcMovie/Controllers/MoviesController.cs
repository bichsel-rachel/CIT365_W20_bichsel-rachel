...
namespace MvcMovie.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        public async Task<IActionResult> Index(string movieGenre, string searchString, string sortOrder, string currentFilter, int? pageNumber)
        {
            ...
            //var sortView = View(await movies.AsNoTracking().ToListAsync());
